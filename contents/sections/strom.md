...
Um die folgende Aufgabe zu lösen, müssen wir uns klarmachen, dass $\qty{1}{\milli\ampere}$ dasselbe ist wie $\qty{0,001}{\ampere}$. Beim Lösen muss man aber aufpassen, mit den Nullen nach dem Komma nicht durcheinanderzukommen: Wenn $\qty{1}{\milli\ampere}$ dasselbe wie $\qty{0,001}{\ampere}$ ist, dann ist $\qty{10}{\milli\ampere}$ dasselbe wie $\qty{0,010}{\ampere}$. Demzufolge ist $\qty{40}{\milli\ampere}$ also $\qty{0,040}{\ampere}$. Schlussendlich entspricht $\qty{42}{\milli\ampere}$ also $\qty{0,042}{\ampere}$.
